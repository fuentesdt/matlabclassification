...
transposelayers = [
    ...
    transposedConv2dLayer(2,32,"Stride",[2 2],"Weights",ones(2,2,32),"Bias",zeros(1,1,32))
    ...
    %maxPooling2dLayer(2,'Stride',2)
    transposedConv2dLayer(2,16,"Stride",[2 2],"Weights",ones(2,2,32),"Bias",zeros(1,1,16))
